...
def main(lr, bs, vbs, nN, rR, af):
    ...
    'nNodes': [[150, 70, 30], [150, 70, 30, 15, 6]][nN],
...
# predict the valid samples and produce plots    
    ...
    with open(outFolder+"modelSummary.txt", "a+") as f:
        print(hp['learningRate'],"\t",hp['batchSize'],"\t",hp['validBatchSize'],"\t",hp['nNodes'],"\t",hp['nDense'],"\t",hp['regRate'],"\t",hp['activation'], "\t", mseTest, "\t", corr[0], file=f)
