...
def doTrainingAndEvaluation():
    ...
    # inX_train=np.delete(inX_train,[22,23],1)
    # inX_test=np.delete(inX_test,  [22,23],1)
    #
    #
    # print (inX_train.shape)
    # print (inX_train[0])
    #
    # print (outY_train.shape)
    # print (krRho_train.shape)
    # print (lkrRho_train.shape)
    ...
    optimizer_ = optimizers.Adam(lr = learningRate)


    # pfn = PFN(input_dim=inX_train.shape[-1], Phi_sizes=Phi_sizes, F_sizes=F_sizes, output_dim=1, loss='mean_squared_error', metrics=['mean_squared_error','mean_absolute_error'],output_act='sigmoid',
    #         Phi_acts='relu',F_acts='relu',patience=5,optimizer=optimizer_)
    pfn = PFN(input_dim=inX_train.shape[-1], Phi_sizes=Phi_sizes, F_sizes=F_sizes,output_dim=1, loss='mean_squared_error', metrics=['mean_squared_error','mean_absolute_error'],output_act='linear',
    ...
    y_predicted = pfn.predict(inX_test)
