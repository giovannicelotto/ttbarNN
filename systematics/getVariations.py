...
def getVarNames():
    varNames = ['weight',               'leptonSF',             'triggerSF',                    'btagSF',               'pileupSF', 'prefiringWeight',
                ...
                'var_ele_reco_down',    'var_ele_reco_up',      'var_muon_id_down',             'var_muon_id_up',
                'var_muon_id_syst_down','var_muon_id_syst_up',  'var_muon_id_stat_down',        'var_muon_id_stat_up',
                'var_muon_iso_down',    'var_muon_iso_up',      'var_muon_iso_syst_down',       'var_muon_iso_syst_up',
                'var_muon_iso_stat_down', 'var_muon_iso_stat_up', 'var_pu_down',                'var_pu_up',
                'var_btag_pu_down',     'var_btag_pu_up',       'var_trig_down',                'var_trig_up',
                ...
                'var_bfrag_down',       'var_bfrag_up',         'var_btag_bfrag_down',          'var_btag_bfrag_up',
                'var_bfrag_central',    'vat_btag_bfrag_central',
                'var_psscale_weight_4_down', 'var_psscale_weight_4_up',
                'var_psscale_weight_5_down', 'var_psscale_weight_5_up', 'var_bfrag_peterson',   'var_btag_bfrag_peterson',
                'var_top_pt']
...
# TRG does not affect b-tag        
        ...
        var_psscale_weight_4_down = np.array([0], dtype='f')
        var_psscale_weight_4_up = np.array([0], dtype='f')
        var_psscale_weight_5_down = np.array([0], dtype='f')
        var_psscale_weight_5_up = np.array([0], dtype='f')
        ...
        tree.SetBranchAddress("var_PSSCALE_WEIGHT_4_DOWN", var_psscale_weight_4_down)
        tree.SetBranchAddress("var_PSSCALE_WEIGHT_4_UP", var_psscale_weight_4_up)
        tree.SetBranchAddress("var_PSSCALE_WEIGHT_5_DOWN", var_psscale_weight_5_down)
        tree.SetBranchAddress("var_PSSCALE_WEIGHT_5_UP", var_psscale_weight_5_up)
...
# Weights and SF
        ...
        for i in range(tree.GetEntries()):
            ...
            weightsSFVar.append(var_psscale_weight_4_down[0])
            weightsSFVar.append(var_psscale_weight_4_up[0])
            weightsSFVar.append(var_psscale_weight_5_down[0])
            weightsSFVar.append(var_psscale_weight_5_up[0])
    ...
    assert len(weightsSFVar) == len (getVarNames()), "length of names and variation not matching"
